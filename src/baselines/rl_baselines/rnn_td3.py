...
def get_args():
    ...
    parser.add_argument("--task", type=str, default="Interactive_Blicket_TD3_RNN")
...
def train_td3_rnn(args=get_args()):
    ...
    log_file = f'seed_{args.seed}_{t0}-{args.task.replace("-", "_")}_td3_rnn'
    log_path = os.path.join(args.logdir, args.task, "td3_rnn", log_file)
